...
export function PreviewPage(props){
    ...
    return (
        ...
        <SideBar currentFont={currentFont} setCurrentFont={setCurrentFont} currentLayout={currentLayout} setCurrentLayout={setCurrentLayout} />
        <div className={`flex ${currentLayout} ${currentFont}`}>
            <h1>Preview Page</h1>
